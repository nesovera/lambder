 ...
 */
export type LambderRequestCompressionSettings = { minBytes: number };
 ...
 */
const compressPayloadWith = async <TField extends string>(
    json: string,
    minBytes: number,
    field: TField,
 ...
 */
export const resolveRequestCompressionMinBytes = (
    compressRequest: boolean | undefined,
    settings: { minBytes: number } | null | undefined,
): number | null =>
    compressRequest === true ? 0
