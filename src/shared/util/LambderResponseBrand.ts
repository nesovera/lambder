 ...
 */
export const LAMBDER_RESPONSE_BRAND: unique symbol = Symbol.for("lambder.response");
 ...
 * package.
 */
export const isLambderResponseLike = (value: unknown): value is { readonly [LAMBDER_RESPONSE_BRAND]: true } =>
    typeof value === "object" && value !== null && (value as Record<symbol, unknown>)[LAMBDER_RESPONSE_BRAND] === true;
